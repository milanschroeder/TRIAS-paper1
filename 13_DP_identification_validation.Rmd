...
```{r}
bart_sub <- zeroshot %>% 
  mutate(max_subtopic = pmax(digital_communications, internet_technologies, digital_services, `digital algorithms`, digitized_data, digital_policy, na.rm = T)) %>%
  pivot_longer(c(digital_communications, internet_technologies, digital_services, `digital algorithms`, digitized_data, digital_policy, max_subtopic), 
               names_to = "label", 
               values_to = "score")
