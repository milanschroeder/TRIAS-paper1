...
# all english speeches, readouts, PRs, Statements:
...
write_csv(all_other_unique_texts, "data/all_other_unique_texts.csv")
googledrive::drive_upload("data/all_other_unique_texts.csv", "TRIAS/")
